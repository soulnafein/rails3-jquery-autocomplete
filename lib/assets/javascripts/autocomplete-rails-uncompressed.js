    ...
    init: function(e) {
      ...
      jQuery(e).autocomplete({
        source: function( request, response ) {
          parameter_name = jQuery(e).attr('data-autocomplete-querystring');
          params = {};
          params[parameter_name] = extractLast( request.term );
          url = jQuery(e).attr('data-autocomplete');
        ...
        select: function( event, ui ) {
          ...
          terms.push( ui.item[jQuery(this).attr('data-autocomplete-label')] );
        ...
        return $( "<li></li>" )
          ...
          .append( "<a>" + item[jQuery(e).attr('data-autocomplete-label')] + "</a>" )
          .appendTo( ul );
      };
    }
  });
